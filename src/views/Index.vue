          ...
          <div class="flex-1 p-6 space-y-6">
            ...
            <div class="space-y-3 relative z-10">
              <div>
                ...
                <select id="ativo" v-model="ativoSelecionado" class="w-full p-4 text-base rounded-lg bg-gray-800/50 border border-amber-400/20 text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition">
              ...
              <div>
                ...
                <select id="expiracao" v-model="expiracaoSelecionada" class="w-full p-4 text-base rounded-lg bg-gray-800/50 border border-amber-400/20 text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition">
            ...
            <div class="space-y-3 pt-2">
              ...
              >
                <div class="relative flex items-center justify-center py-5 px-8">
              ...
              <div v-if="analisandoSinal" class="w-full relative overflow-hidden rounded-lg border-2 border-blue-400/50 bg-gradient-to-r from-blue-500/20 to-blue-600/20">
                <div class="relative flex items-center justify-center py-3 px-6">
            ...
            <div class="space-y-6">
              ...
              <div class="bg-gray-800/50 border border-amber-400/20 rounded-lg p-3">
